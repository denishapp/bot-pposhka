...
const RULES_TEXT = `🕹 *Правила гри ППОШКА*
...
1. Підпишіться на [сторінку 125 ОВМБр в Instagram](https://www.instagram.com/125ovmbr/).
2. Під час реєстрації вкажіть свій нікнейм в Instagram або номер телефону, до якого прив'язаний Telegram. Це потрібно, щоб ми могли зв'язатися з вами у разі перемоги.
3. Збийте якомога більше ворожих БПЛА.
4. Увійдіть до трійки лідерів.
5. Отримайте у подарунок худі «Skyfall × 125 ОВМБр».`;

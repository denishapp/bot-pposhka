...
1. Підписатися на інстаграм @125ovmbr 
2. На сторінці реєстрації вкажіть свій нікнейм в Instagram або номер телефону, до якого прив'язаний Telegram, це потрібно щоб ми могли з вами звʼязатися якщо ви переможете у розіграші.
3. Збийте якомога більше ворожих БПЛА.
4. Увійдіть до трійки лідерів.
5.  Отримайте худі «Skyfall × 125 ОВМБр» у подарунок.`;
